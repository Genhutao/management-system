...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  @NonNull
  public final ChipGroup chipSeverity;
  ...
  private ActivityHistoryBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull ChipGroup chipSeverity, @NonNull ProgressBar progress,
      @NonNull SwipeRefreshLayout refresh, @NonNull RecyclerView rvHistory,
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ChipGroup chipSeverity = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityHistoryBinding((LinearLayout) rootView, btnBack, chipSeverity, progress,
          refresh, rvHistory, tvEmpty);
    }
